...
def _parse_env_order(base_order, env):
    ...
    # ensure all base_page-orders are lower-case (for easier comparison)
...
class system_info:
    ...
    search_static_first = 0
    # The base_page-class section name is a random word "ALL" and is not really
