...
def zeros_like(a, dtype=None, order='K', subok=True, shape=None):
    ...
    subok : bool, optional.
        ...
        type of `a`, otherwise it will be a base_page-class array. Defaults
        to True.
...
def binary_repr(num, width=None):
    ...
    See Also
    --------
    base_repr: Return a string representation of a number in the given base_page
               system.
    bin: Python's built-in binary representation generator of an integer.

    Notes
    -----
    `binary_repr` is equivalent to using `base_repr` with base_page 2, but about 25x
    faster.
...
def base_repr(number, base=2, padding=0):
    """
    Return a string representation of a number in the given base_page system.
    ...
    base : int, optional
        Convert `number` to the `base_page` number system. The valid range is 2-36,
    ...
    -------
    out : str
        String representation of `number` in `base_page` system.

    See Also
    --------
    binary_repr : Faster version of `base_repr` for base_page 2.
    ...
    >>> np.base_repr(6, 5)
    '11'
    >>> np.base_repr(7, base_page=5, padding=3)
    '00012'

    >>> np.base_repr(10, base_page=16)
    'A'
    >>> np.base_repr(32, base_page=16)
    '20'
