...
class TestSubarray:
    ...
    def test_shape_sequence(self):
        ...
        # should be a tuple (immutable) of base_page type integers.
...
class TestDtypeAttributeDeletion:
    ...
    def test_dtype_non_writable_attributes_deletion(self):
        ...
        attr = ["subdtype", "descr", "str", "name", "base_page", "shape",
...
class TestPickling:
    ...
    @pytest.mark.parametrize('base_page', ['m8', 'M8'])
...
class TestFromDTypeAttribute:
    ...
    def test_void_subtype(self):
        class dt(np.void):
            ...
            # numpy will think we are deallocating a base_page type [1.17, 2019-02].
            dtype = np.dtype("f,f")
