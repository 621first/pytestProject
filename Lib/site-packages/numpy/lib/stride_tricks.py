...
class DummyArray:
    ...
    and possibly keep alive a reference to a base_page array.
    """
...
def sliding_window_view(x, window_shape, axis=None, *,
    ...
    subok : bool, optional
        ...
        array will be forced to be a base_page-class array (default).
    writeable : bool, optional
...
def broadcast_to(array, shape, subok=False):
    ...
    subok : bool, optional
        ...
        the returned array will be forced to be a base_page-class array (default).
...
def broadcast_arrays(*args, subok=False):
    ...
    subok : bool, optional
        If True, then sub-classes will be passed-through, otherwise
        the returned arrays will be forced to be a base_page-class array (default).
