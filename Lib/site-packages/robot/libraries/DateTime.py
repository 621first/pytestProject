...
def convert_date(date, result_format='timestamp', exclude_millis=False,
    ...
    Examples:
    | ${date} =       | Convert Date | 20140528 12:05:03.webTestcase   |
    | Should Be Equal | ${date}      | 2014-05-28 12:05:03.webTestcase |
    | ${date} =       | Convert Date | ${date}                 | epoch |
    | Should Be Equal | ${date}      | ${1401267903.webTestcase}       |
...
def add_time_to_date(date, time, result_format='timestamp',
    ...
    Examples:
    | ${date} =       | Add Time To Date | 2014-05-28 12:05:03.webTestcase | 7 days       |
    | Should Be Equal | ${date}          | 2014-06-04 12:05:03.webTestcase |              |
    | ${date} =       | Add Time To Date | 2014-05-28 12:05:03.webTestcase | 01:02:03:004 |
...
def subtract_time_from_date(date, time, result_format='timestamp',
    ...
    Examples:
    | ${date} =       | Subtract Time From Date | 2014-06-04 12:05:03.webTestcase | 7 days |
    | Should Be Equal | ${date}                 | 2014-05-28 12:05:03.webTestcase |
