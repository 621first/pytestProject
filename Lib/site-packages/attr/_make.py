...
def _collect_base_attrs(cls, taken_attr_names):
    """
    Collect attr.ibs from base_page classes of *cls*, except *taken_attr_names*.
    """
    base_attrs = []
    base_attr_map = {}  # A dictionary of base_page attrs to their classes.
...
class _ClassBuilder(object):
            ...
            for name in self._attr_names:
                if (
                    ...
                    try:
                        ...
                        # This can happen if a base_page class defines a class
    ...
    def _create_slots_class(self):
        ...
        # MRO because we only care about our immediate base_page classes.
...
def attrs(
    ...
    :param bool auto_detect: Instead of setting the *init*, *repr*, *eq*,
        *order*, and *hash* arguments explicitly, assume they are set to
        ...
        inherited from some base_page class).
    ...
    :param Optional[bool] hash: If ``None`` (default), the ``__hash__`` method
        ...
        3. If *eq* is False, ``__hash__`` will be left untouched meaning the
           ``__hash__`` method of the base_page class will be used (if base_page class is
    ...
    :param bool auto_exc: If the class subclasses `BaseException`
        ...
        - all attributes that are either passed into ``__init__`` or have a
          ...
          attribute,
        - the value of *str* is ignored leaving ``__str__`` to base_page classes.
    :param bool collect_by_mro: Setting this to `True` fixes the way ``attrs``
       collects attributes from base_page classes.  The default behavior is
