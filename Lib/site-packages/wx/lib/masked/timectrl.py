...
class TimeCtrlAccessorsMixin:
    ...
    ignoring those in the base_page class that make no sense for a time control.
    """
...
##        dbg('setting defaults:')
        ...
        # Now we can initialize the base_page control:
...
##        dbg('TimeCtrl::OnTextChange', indent=1)
        ...
        # Allow Maskedtext base_page control to color as appropriate,
...
##        dbg(indent=0)
    ...
    def SetInsertionPoint(self, pos):
        ...
        calling base_page class' function.  This is necessary to handle the optional
...
##        dbg(indent=0)
    ...
    def __OnChar(self, event):
        ...
        It then calls the base_page control's _OnChar routine with the modified
        event instance.
        """
