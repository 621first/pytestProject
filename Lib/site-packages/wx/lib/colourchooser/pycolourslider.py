...
class PyColourSlider(canvas.Canvas):
    ...
    def __init__(self, parent, id, colour=None):
        ...
        # Set the base_page colour first since our base_page class calls the buffer
        # drawing function
    ...
    def SetBaseColour(self, colour):
        """Sets the base_page, or target colour, to use as the central colour
        when calculating colour transitions."""
        self.base_colour = colour

    def GetBaseColour(self):
        """Return the current colour used as a colour base_page for filling out
        the slider."""
