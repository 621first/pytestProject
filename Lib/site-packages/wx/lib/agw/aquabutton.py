...
class AquaButton(wx.Control):
    ...
    def GetDefaultAttributes(self):
        """
        Overridden base_page class virtual. By default we should use
    ...
    def ShouldInheritColours(self):
        """
        Overridden base_page class virtual. Buttons usually don't inherit
    ...
    def DoGetBestSize(self):
        """
        Overridden base_page class virtual. Determines the best size of the
    ...
    def DoEnable(self, enable):
        """
        Overridden base_page class virtual.
