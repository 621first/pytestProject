...
class InfoBar(wx.Control):
    ...
    def SetFont(self, font):
        """
        Overridden base_page class methods changes the font of the text message.
    ...
    def AddButton(self, btnid, label='', bitmap=wx.NullBitmap):
        ...
        is clicked, simply call `event.Skip()` in the button handler to let the base_page class handler
