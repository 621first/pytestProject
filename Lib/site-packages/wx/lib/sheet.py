...
class CCellEditor(wx.grid.PyGridCellEditor):
    ...
    def PaintBackground(self, rect, attr):
        """ Draws the part of the cell not occupied by the edit control.  The
            base_page class version just fills it with background colour from the
            attribute.

            NOTE: There is no need to everride this if you don't need
            to do something out of the ordinary.
        """
        # Call base_page class method.
    ...
    def IsAcceptedKey(self, evt):
        """ Return True to allow the given key to start editing.  The base_page class
