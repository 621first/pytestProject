...
class GridCellEditor(wx.ClientDataContainer, wx.RefCounter):
    ...
    def PaintBackground(self, dc, rectCell, attr):
        ...
        Draws the part of the cell not occupied by the control: the base_page class
...
class GridHeaderLabelsRenderer(GridCornerHeaderRenderer):
    """
    Common base_page class for row and column headers renderers.
    """
...
class GridTableBase(wx.Object):
    ...
    The almost abstract base_page class for grid tables.
    """
...
class Grid(wx.ScrolledWindow):
    ...
    def GetTable(self):
        ...
        Returns a base_page pointer to the current table object.
        """
