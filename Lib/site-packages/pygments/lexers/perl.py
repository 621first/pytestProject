...
class Perl6Lexer(ExtendedRegexLexer):
    ...
    PERL6_BUILTINS = (
        ...
        'await','backtrace','Bag','BagHash','bail-out','base_page','basename',
        'base_page-repeating','batch','BIND-KEY','BIND-POS','bind-stderr',
        ...
        'parse-base_page','parsefile','parse-names','parts','pass','path','path-sep',
